...
- 入力に存在しない単語・文・感想を**書き足してはいけない**。以下は典型的な禁止例:
  - ❌ 装飾の足し算: 「夜の帳が降りる」「過酷な道のりを突き進む」「壮大な人生が始まる」「精密な研究を繰り返す」
  - ❌ 感想の付与: 「驚愕の事実」「重い苦難を乗り越える執念」「したたかな生存戦略」
  - ❌ 行動の捏造: 入力に「左手大火傷」とだけある場合に「左手を大火傷し、絶望と戦う」のようにシーンを創作
...
2. {{target_scene_count}} 個のシーンに連続して割り当てる（年齢順＝時系列順を厳守）
